...
<a id="user-content-tiny-slider-2" class="anchor" href="#tiny-slider-2" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Tiny Slider 2</h1>
...
<a href="https://camo.githubusercontent.com/3ce78b52987e6c3ff322faef5324f9c6feaf41cc/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f56657273696f6e2d322e392e322d677265656e2e737667" target="_blank" rel="nofollow"><img src="https://camo.githubusercontent.com/3ce78b52987e6c3ff322faef5324f9c6feaf41cc/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f56657273696f6e2d322e392e322d677265656e2e737667" alt="version" data-canonical-src="https://img.shields.io/badge/Version-2.9.3-green.svg" style="max-width:100%;"></a></p>
<p>Tiny slider for all purposes, inspired by <a href="https://owlcarousel2.github.io/OwlCarousel2/" rel="nofollow">Owl Carousel</a>.</p>
<p><a href="http://ganlanyuan.github.io/tiny-slider/demo" rel="nofollow">Demos</a></p>
<p><a href="http://ganlanyuan.github.io/tiny-slider/test" rel="nofollow">Test results</a></p>
...
<li><a href="#responsive-options">Responsive options</a></li>
...
<li>Save browser capability values to <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage" rel="nofollow">localStorage</a>, so they will not be recheck again until browser get upgraded or user clear the localStorage manually.</li>
...
<p><em><a href="#tiny-slider-2">top↑</a></em></p>
<h2>
...
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">link</span> <span class="pl-e">rel</span>=<span class="pl-s"><span class="pl-pds">"</span>stylesheet<span class="pl-pds">"</span></span> <span class="pl-e">href</span>=<span class="pl-s"><span class="pl-pds">"</span>https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.3/tiny-slider.css<span class="pl-pds">"</span></span>&gt;
<span class="pl-c"><span class="pl-c">&lt;!--</span>[if (lt IE 9)]&gt;&lt;script src="https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.3/min/tiny-slider.helper.ie8.js"&gt;&lt;/script&gt;&lt;![endif]<span class="pl-c">--&gt;</span></span></pre></div>
<h4>
...
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">script</span> <span class="pl-e">src</span>=<span class="pl-s"><span class="pl-pds">"</span>https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.3/min/tiny-slider.js<span class="pl-pds">"</span></span>&gt;&lt;/<span class="pl-ent">script</span>&gt;
...
<p>Option B: Import <code>tns</code> via <code>webpack</code> or <code>rollup</code>:</p>
...
<p>Option C: Import <code>tns</code> directly start from v2.8.2</p>
...
<tr>
<td>
<code>viewportMax</code> (was <code>fixedWidthViewportWidth</code>)</td>
<td>positive integer | false</td>
...
<td>Boolean</td>
<td>Default: true. <br> Pauses the sliding when the page is invisible and resumes it when the page become visiable again. (<a href="https://developer.mozilla.org/en-US/docs/Web/API/Page_Visibility_API" rel="nofollow">Page Visibility API</a>)</td>
</tr>
<tr>
...
<tr>
<td>
<code>preventActionWhenRunning</code> (v2.9.1+)</td>
<td>Boolean</td>
<td>Default: false. <br> Prevent next transition while slider is transforming.</td>
</tr>
<tr>
<td>
<code>preventScrollOnTouch</code> (v2.9.1+)</td>
...
<td>Default: false. <br> Define the relationship between nested sliders. (see <a href="http://ganlanyuan.github.io/tiny-slider/demo/#nested_wrapper" rel="nofollow">demo</a>) <br>Make sure you run the inner slider first, otherwise the height of the inner slider container will be wrong.</td>
</tr>
<tr>
...
<li>
<code>fixedWidth</code> can only be changed to other positive integers. It can't be changed to negative integer, 0 or other data type.
<em><a href="#tiny-slider-2">top↑</a></em>
</li>
</ul>
<h2>
...
<div class="highlight highlight-source-js"><pre>{
  version<span class="pl-k">:</span> version, <span class="pl-c"><span class="pl-c">//</span> tiny-slider version</span>
  ...
  updateSliderHeight<span class="pl-k">:</span> <span class="pl-en">updateInnerWrapperHeight</span>(),
  refresh<span class="pl-k">:</span> <span class="pl-en">initSliderTransform</span>(),
...
<div class="highlight highlight-source-js"><pre>{
        ...
        controlsContainer<span class="pl-k">:</span> controlsContainer, <span class="pl-c"><span class="pl-c">//</span> controls container</span>
            ...
            slideCountNew<span class="pl-k">:</span> slideCountNew, <span class="pl-c"><span class="pl-c">//</span> total slide count after initialization</span>
             ...
             displayIndex<span class="pl-k">:</span> <span class="pl-en">getCurrentSlide</span>(), <span class="pl-c"><span class="pl-c">//</span> display index starts from 1</span>
         ...
         navCurrentCached<span class="pl-k">:</span> navCurrentCached, <span class="pl-c"><span class="pl-c">//</span> previous dot index</span>
                    pages<span class="pl-k">:</span> pages, <span class="pl-c"><span class="pl-c">//</span> visible nav indexes</span>
              pagesCached<span class="pl-k">:</span> pagesCached,
...
<h4>
<a id="user-content-updatesliderheight" class="anchor" href="#updatesliderheight" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>updateSliderHeight</h4>
<p>Manually adjust slider height when <code>autoHeight</code> is <code>true</code>.</p>
<div class="highlight highlight-source-js"><pre><span class="pl-smi">slider</span>.<span class="pl-en">updateSliderHeight</span>();</pre></div>
<h4>
...
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> <span class="pl-en">customizedFunction</span> <span class="pl-k">=</span> <span class="pl-k">function</span> (<span class="pl-smi">info</span>, <span class="pl-smi">eventName</span>) {
...
<br>
<a href="https://cdnjs.com/" rel="nofollow">Cdnjs</a>
<br>
